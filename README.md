...
Now transform it by [adding comments for query set generation](https://github.com/tidbcloud/go-queryset/blob/master/examples/comparison/gorm4/gorm4.go#L15):
```go
